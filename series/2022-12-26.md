...
As in the proof for $\zeta(2)$ in [Taylor Series](2022-12-25), we utilize the properties of a polynomial to gain more information on its coefficients. The theory of generating functions begins by assigning the sequence as the coefficients of the polynomial:
...
is much more natural than either of the forms provided in [2D Recurrences and Combinatorial Arguments](2022-12-21), either
