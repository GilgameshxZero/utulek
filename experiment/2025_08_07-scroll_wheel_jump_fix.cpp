...
LRESULT CALLBACK lowLevelMouseProc(
	...
	// Ignore if different direction and the switch was too
	// fast. Allow multiple rejections in a row.
	Rain::Console::log(
		"Scroll: (", dir, ", ", timeDelta, ").");
...
int main(int argc, const char *const *argv) {
	...
	HHOOK llKbHook{validateSystemCall(SetWindowsHookEx(
		WH_MOUSE_LL, lowLevelMouseProc, hInstance, NULL))};
